...
class EmailTemplateController extends Controller
{
    public function index()
    {
        ...
        $emptyMessage = __('No templates available');
    ...
    public function edit($id)
    {
        ...
        $emptyMessage = __('No shortcode available');
    ...
    {
        $pageTitle = __('Email Configuration');
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', __('Email configuration has been updated.')];
        return back()->withNotify($notify);
    }
    ...
    public function emailTemplateUpdate(Request $request)
    {
        ...
        $notify[] = ['success', __('Global email template has been updated.')];
        return back()->withNotify($notify);
    }
    ...
    public function sendTestMail(Request $request)
    {
        ...
        $message = __('This is a test email, please ignore it if you are not meant to get this email.');

        try {
            sendGeneralEmail($request->email, $subject, $message, $receiver_name);
        } catch (\Exception $exp) {
            $notify[] = ['error', __('Invalid credential')];
            return back()->withNotify($notify);
