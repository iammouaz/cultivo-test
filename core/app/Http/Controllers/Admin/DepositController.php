...
class DepositController extends Controller
{
    ...
    public function pending()
    {
        ...
        $emptyMessage = __('No pending deposits.');
    ...
    public function approved()
    {
        ...
        $emptyMessage = __('No approved deposits.');
    ...
    public function successful()
    {
        ...
        $emptyMessage = __('No successful deposits.');
    ...
    public function rejected()
    {
        ...
        $emptyMessage = __('No rejected deposits.');
    ...
    public function deposit()
    {
        ...
        $emptyMessage = __('No deposit history available.');
    ...
    public function depositViaMethod($method,$type = null){
        ...
        $emptyMessage = __('No Deposit Found');
    ...
    public function search(Request $request, $scope)
    {
        ...
        $emptyMessage = __('No search result was found.');
    ...
    public function dateSearch(Request $request,$scope = null){
        ...
        if ($start && !preg_match($pattern,$start)) {
            $notify[] = ['error',__('Invalid date format')];
    ...
    public function approve(Request $request)
    {
        ...
        $notify[] = ['success', __('Deposit request has been approved.')];
    ...
    public function reject(Request $request)
    {
        ...
        $notify[] = ['success', __('Deposit request has been rejected.')];
        return  redirect()->route('admin.deposit.pending')->withNotify($notify);
