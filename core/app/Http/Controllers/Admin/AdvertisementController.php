...
class AdvertisementController extends Controller
{
    public function index()
    {
        ...
        $pageTitle = __('All Advertisements');
        $emptyMessage = __('No advertisement found.');
    ...
    public function update(Request $request, $id)
    {
        ...
        $advertisement->save();
        $notify[] = ['success', __('Advertisement Updated Successfully')];
        return redirect()->route('admin.advertisement.index')->withNotify($notify);
    }
    ...
    public function delete(Request $request){
        ...
        $notify[] = ['success', __('Advertisement Deleted Successfully')];
