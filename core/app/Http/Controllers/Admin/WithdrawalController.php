...
class WithdrawalController extends Controller
{
    public function pending()
    {
        ...
        $emptyMessage = __('No withdrawal found');
    ...
    public function log()
    {
        ...
        $emptyMessage = __('No withdrawal history');
        return view('admin.withdraw.withdrawals', compact('pageTitle', 'withdrawals', 'emptyMessage'));
    }
    ...
    public function dateSearch(Request $request,$scope){
        ...
        $emptyMessage = __('No Withdrawals Found');
        $dateSearch = $search;
    ...
    public function approve(Request $request)
    {
        ...
        $notify[] = ['success', __('Withdrawal marked as approved.')];
    ...
    public function reject(Request $request)
    {
        ...
        $notify[] = ['success', __('Withdrawal has been rejected.')];
        return redirect()->route('admin.withdraw.pending')->withNotify($notify);
    }
