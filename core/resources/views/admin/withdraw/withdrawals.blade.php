                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Amount')">
                                   {{ $general->cur_sym }}{{ showAmount($withdraw->amount ) }} - <span class="text-danger" data-toggle="tooltip" data-original-title="@lang('charge')">{{ showAmount($withdraw->charge)}} </span>
                                    <br>
                                ...
                                <td data-label="@lang('Conversion')">
                                   1 {{ $general->cur_text }} =  {{ showAmount($withdraw->rate) }} {{ $withdraw->currency }}
                                    <br>
                                    <strong>{{ showAmount($withdraw->final_amount) }} {{ $withdraw->currency }}</strong>
                                </td>
