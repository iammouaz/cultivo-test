...
<div class="row  mb-30">
    <div class="card mt-50">
        <div class="card-body">
            <form action="{{ route('admin.admin.addPost') }}" method="POST" onsubmit="return submitUserForm();" class="account--form g-4">
                @csrf
                ...
                <button type="submit" class="cmn--btn w-100 btn btn--primary btn-block btn-lg">@lang('Add Admin')</button>
            </form>
        </div>
    </div>
</div>
