...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.product.import-product-from-csv') }}" method="POST"
...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('admin.product.template.download') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i
