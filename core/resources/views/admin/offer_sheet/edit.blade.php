...
@section('panel')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h6>Update Offer Sheet</h6>
        <div class="d-flex " style="gap: 12px">
            <a href="{{ route('offer_sheet.activeOffers', $event->offer_sheet_url) }}"> <button type="button"
                    class="btn btn-md btn-outline-dark float-right"><i class="la la-eye px-1"></i>@lang('Preview Event')
                </button>
            </a>

            <a href="{{ route('admin.offer.create', ['id' => $event->id]) }}">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <form action="{{ route('admin.offer_sheet.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                                    ...
                                    <div class="payment-method-header">
                                        ...
                                        <div class="form-group w-100">
                                            <div class="mb-2 w-100">
                                                <h5 class="font-weight-bold mb-3">@lang('Banner Image')</h5>
                                            </div>
                                            <div class="thumb mb-0 w-100">
                                                <div class="avatar-preview w-100">
                                                    <div class="profilePicPreview w-100 rounded"
                                                        style="background-image: url('{{ getImage(imagePath()['event']['path'] . '/' . $event->image, imagePath()['event']['size']) }}');border:dashed 2px #AAAAAA;box-shadow:unset">
                                        ...
                                        <div class="form-group w-100">
                                            ...
                                            <div class="thumb mb-0 w-100">
                                                <div class="avatar-preview w-100">
                                                    <div class="profilePicPreview w-100 rounded"
                                                        style="background-image: url('{{ getImage(imagePath()['event_logo']['path'] . '/' . $event->banner_logo, imagePath()['event_logo']['size']) }}');border:dashed 2px #AAAAAA;box-shadow:unset">
                                        ...
                                        <div class="form-group w-100">
                                            ...
                                            <div class="thumb mb-0 w-100">
                                                <div class="avatar-preview w-100">
                                                    <div class="profilePicPreview w-100 rounded"
                                                        style="background-image: url('{{ getImage(imagePath()['event_logo']['path'] . '/' . $event->card_logo, imagePath()['event_logo']['size']) }}');border:dashed 2px #AAAAAA;box-shadow:unset">


                                                        <div style="height: 0px;">
                                                            <input type="file" name="card_logo" class="profilePicUpload"
                                                                id="card_logo" accept=".png, .jpg, .jpeg" />
                                                            <label for="card_logo"
                                                                style="position: absolute;top:70%;left:50%;transform:translate(-50%)">
                                                                <div class="btn  btn-light box--shadow1 text--small">
                                                                    Select Image
                                        ...
                                        <div class="d-flex flex-column" style="gap: 12px">
                                            ...
                                            <div class="slide-switch d-flex align-items-center ">
                                                <label class="switch">
                                                    <input readonly name="order" id="order" type="checkbox"
                                                        value="1" @if ($event->show_add_order_button === 1) checked @endif>
                                            ...
                                            <div class="slide-switch d-flex align-items-center ">
                                                <label class="switch">
                                                    ...
                                                    <input readonly name="offer" id="offer" type="checkbox"
                                                        value="1" @if ($event->show_make_offer_button) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            ...
                                            <div class="slide-switch d-flex align-items-center ">
                                                <label class="switch">
                                                    <input name="sample" id="sample" type="checkbox" value="1"
                                                        @if ($event->show_add_sample_button) checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="w-100">
                                            <h5 class="font-weight-bold mb-3">@lang('Offer sheet')
                                                <a href="{{ route('admin.product.index', $event->id) }}"> <button
                                                        type="button" class="btn btn-md btn-outline-dark float-right"><i
                                        ...
                                        <div class="row">
                                                    ...
                                                    <select class="origin" name="origin[]">
                                                        @foreach ($origins as $origin)
                                                            <option value="{{ $origin->id }}"
                                                                @if ($event->origins()->where('origin_id', $origin->id)->exists()) selected @endif>
                                                                {{ $origin->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            {{--                                                        <option value="{{ $event->category->id }}"> --}}
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold">@lang('Description')<span
                                                            class="text-danger">*</span></label>
                                                    <textarea rows="4" class="form-control border-radius-5" required name="description">{{ old('description') ?? $event->description }}</textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <input id="url" type="text" class="form-control w-50 "
                                                            ...
                                                            value="{{ old('url') ? old('url') : $event->offer_sheet_url }}"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold">@lang('Order Notifications To* (Add Emails Comma Spereated)')<span
                                                            class="text-danger">*</span></label>
                                                    <textarea rows="4" class="form-control border-radius-5" required name="emails">{{ old('emails', $event->emails) }}</textarea>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="input-group mb-md-0 mb-4">
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <input required
                                                                        ...
                                                                        type="text" placeholder="@lang('Size')">
                                                                </div>
                                                                ...
                                                                <div class="col-lg-2 text-center">
                                                                    ...
                                                                    <input style="width: 15px;height:15px !important"
                                                                        class="form-check-input position-relative m-0 is_sample_input"
                                                                        name="sizes[0][is_sample]" type="checkbox"
                                                    ...
                                                    <h6 class="mb-2">@lang('Sizes')
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-dark float-right addSize"><i
                                                                class="la la-fw la-plus"></i>@lang('Add New Size')
                                                        </button>
                                                    </h6>
                                                    {{-- <div class="card-body"> --}}
                                                    <div class="addedField radiobox_item_type">
                                                        @foreach ($event->sizes as $key => $size)
                                                            <div class="row w-100">
                                                                        ...
                                                                        <div class="input-group mb-md-0 mb-4">
                                                                            ...
                                                                            <div class="col-lg-2 text-center">
                                                                                ...
                                                                                <input
                                                                                    ...
                                                                                    class="form-check-input position-relative m-0 is_sample_input"
                                                                                    name="sizes[{{ $key }}][is_sample]"
                                                                                    type="radio" id="sizes-radio"
                                                                                    value="{{ $size->is_sample }}"
                                                                                    {{ $size->is_sample ? 'checked' : '' }} />
...
@push('script')
    <script>
        (function($) {
            "use strict";
            var sizeIndex = {{ old('sizes') ? count(old('sizes')) : count($event->sizes) }}; // used for add size
