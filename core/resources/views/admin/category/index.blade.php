                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Events')">{{ $category->events->count() }}</td>
                                ...
                                <td data-label="@lang('Action')">
                                    <button type="button" class="icon-btn editCategory" data-id="{{ $category->id }}" data-name="{{ $category->name}}" data-description="{{ $category->description }}" data-icon="{{ $category->icon }}" data-status="{{ $category->status }}" data-toggle="tooltip"  data-original-title="@lang('Edit')">
