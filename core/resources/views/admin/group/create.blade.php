                            ...
                            <div class="payment-method-header">
                                <div class="form-group">
                                    ...
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview" style="background-image: url('{{getImage(imagePath()['group']['path'],imagePath()['group']['size'])}}')"></div>
                                        </div>
                                ...
                                <div class="content">
                                    <div class="row mb-none-15">
                                        ...
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <div class="form-group">
                                                <label class="w-100 font-weight-bold">@lang('Leader') <span class="text-danger">*</span></label>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.group.index',[$id]) }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-fw la-backward"></i> @lang('Go Back') </a>
@endpush
