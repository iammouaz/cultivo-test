...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.permissiongroup.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                                    ...
                                    <div class="row mb-none-15">
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " placeholder="@lang('Group Name')" name="name" value="{{ old('name') }}" required/>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-xl-4 col-lg-6 mb-15">
                                            <div class="form-group events">
                                                <label class="w-100 font-weight-bold">@lang('Event') <span class="text-danger">*</span></label>
                                            ...
                                            <div class="form-group products">
                                                ...
                                                <select id="products" name="product_id[]" class="form-control" required multiple>
                                                    @foreach ($products as $product)
                                                        <option id="{{ $product->event_id }}" value="{{ $product->id }}">{{'#_'.$id_name_event[$product->event_id] .'_# '.$product->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
