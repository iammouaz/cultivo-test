    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card b-radius--10 ">
                <a style="width: 150px;" class="btn btn-sm btn--primary box--shadow1 text-white text--small ml-auto my-4"
                    data-toggle="modal" data-target="#uploadModal"><i class="fa fa-fw fa-upload"></i>@lang('Upload Language')</a>
                                ...
                                @forelse ($languages as $item)
                                    <tr>
                                        <td data-label="@lang('Name')">{{ $item->name }}
                                            <a href="{{ route('admin.download.lang.csv', ['filename' => $item->code]) }}">
                                                <i style="color: #7367f0;" class="fa fa-fw fa-download"></i>
                                            </a>
                                        </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="uploadModalLabel"> @lang('Add New Language')</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">×</span></button>
                </div>
                <form class="form-horizontal" method="post" enctype="multipart/form-data"
                    action="{{ route('admin.upload.lang.csv') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="form-row form-group">
                            <label class="font-weight-bold ">@lang('Language Name') <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <select name="lang_name" id="code" class="form-control" required>
                        ...
                        <div class="form-row form-group">
                            <label class="font-weight-bold">@lang('Language File') <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
                                <input type="file" class="form-control" accept="csv" id="link" name="csv_file"
                                    required>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <label for="inputName" class="font-weight-bold">@lang('Language Name') <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-12">
...
@push('breadcrumb-plugins')
    <a class="btn btn-sm btn--primary box--shadow1 text-white text--small" data-toggle="modal"
        data-target="#createModal"><i class="fa fa-fw fa-plus"></i>@lang('Add New Language')</a>
@endpush
