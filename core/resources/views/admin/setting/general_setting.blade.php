        ...
        <div class="card">
            <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">@lang('Stop Cart')</label>
                                <input type="checkbox" data-width="100%" data-size="large" value="1"
                                       data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle"
                                       data-on="@lang('Enable')" data-off="@lang('Disabled')" name="stop_cart" @if($general->stop_cart) checked @endif>
                            </div>

                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">@lang('Stop live in not auth users')</label>
                                <input type="checkbox" data-width="100%" data-size="large" value="1"
                                       data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle"
                                       data-on="@lang('Enable')" data-off="@lang('Disabled')" name="stop_live_in_not_auth_users" @if($general->stop_live_in_not_auth_users) checked @endif>
                            </div>
