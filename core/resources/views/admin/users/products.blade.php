        ...
        <div class="card b-radius--10 ">
            <div class="card-body p-0">
                <div class="table-responsive--md  table-responsive">
                 <form method="post" action="{{ route('admin.request.editapproved') }}" id="approve">
                     @csrf
                    <table class="table table--light style--two">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Approve')">
                                <input type="checkbox" form="approve" name="products[]" value="{{$product->id}}" @if(in_array($product->id,$product_ids)) checked @endif>
                            </td>
                        </tr>
