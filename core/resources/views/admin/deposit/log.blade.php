                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                <td data-label="@lang('Gateway | Trx')">
                                     <span class="font-weight-bold"> <a href="{{ route('admin.deposit.method',[$deposit->gateway->alias,'all']) }}">{{$deposit->gateway->name}}</a> </span>
                                     <br>
                                ...
                                <td data-label="@lang('Amount')">
                                   {{ $general->cur_sym}}{{ showAmount($deposit->amount ) }} + <span class="text-danger" data-toggle="tooltip" data-original-title="@lang('charge')">{{ showAmount($deposit->charge)}} </span>
                                    <br>
                                ...
                                <td data-label="@lang('Conversion')">
                                   1 {{$general->cur_text}} =  {{ showAmount($deposit->rate) }} {{$deposit->method_currency}}
                                    <br>
                                    <strong>{{ showAmount($deposit->final_amo) }} {{$deposit->method_currency}}</strong>
                                </td>
