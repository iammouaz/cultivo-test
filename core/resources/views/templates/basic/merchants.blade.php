                ...
                <div class="col-md-6 col-lg-4">
                    <div class="vendor__item bg--section">
                        <div class="vendor__top">
                            <h6 class="title">
                                <a href="{{ route('merchant.profile.view', [$merchant->id, slug($merchant->fullname)]) }}">{{ $merchant->fullname }}</a>
                            </h6>
                            <div class="ratings">
                                @php
                            ...
                            <ul class="vendor__info">
                                <li>
                                    <i class="las la-map-marker-alt"></i> {{ $merchant->address->address }}
                                </li>
                                <li>
                                    <a href="Tel:{{ $merchant->mobile }}"><i class="las la-phone"></i> {{ $merchant->mobile }}</a>
                                </li>
                                <li>
