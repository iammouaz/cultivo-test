        ...
        <div class="account__section-content bg--section account__section-content-reg">
            <div class="w-100">
                ...
                <form action="{{ route('user.register') }}" method="POST" onsubmit="return submitUserForm();" class="account--form g-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" id="mobile" name="billing_phone" value="{{ old('billing_phone') }}" class="form-control checkUser" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <label for="company_name">@lang('Company Name')</label>
                            <input type="text" id="company_name" name="company_name" value="{{ old('company_name') }}" class="form-control" autocomplete="off" required>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <label for="company_website">@lang('Company Website')</label>
                            <input type="text" id="company_website" name="company_website" value="{{ old('company_website') }}" class="form-control" autocomplete="off" required>
                        </div>
                        {{-- <div class="col-sm-6 mb-3">
                    ...
                    @endif
                    {{-- <div class="mb-3">
                            <input type="checkbox" id="opt_in" value="1" name="opt_in">
                            <label for="opt_in" class="ms-1">@lang('Opt in to sms/whatsapp updates ')</label>
                    </div>

                    <div class="mb-3">
                            <input type="checkbox" id="i_contacted_upcoming_auctions" value="1" name="i_contacted_upcoming_auctions">
                            <label for="i_contacted_upcoming_auctions" class="ms-1">@lang('I wish to be contacted in the future regarding upcoming auctions.')</label>
                    </div> --}}

                    <button type="submit" class="cmn--btn w-100">@lang('Register')</button>
                </form>
                <div class="mt-5 text-center text--white">
                    @lang('Already have an Account ? ')<a href="{{ route('user.login') }}" class="primary-color">@lang('Login')</a>
                </div>
            </div>
        </div>
    </div>
