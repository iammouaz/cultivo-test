                                                        ...
                                                        <select name="shipping_country" id="shipping_country"
                                                            ...
                                                            @foreach($countries as $key => $country)
                                                                <option data-mobile_code="{{ $country->dial_code }}"
                                                                        value="{{ $country->id }}"
                                                                        data-code="{{ $key }}"
                                                                        @if($country->id ==  auth()->user()->shipping_country) selected @endif>{{ $country->Name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
            ...
            function get_shipping_methods(){
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#shipping_method').append("<option value='-1'>@lang("I will manage my own shipping")</option>");
                        $('#shipping_method').append("<option value='-2'>@lang("I am part of a bidding group")</option>");
                        $('#shipping_method').append("<option value='-3'>@lang("Air Freight (Request Quote)")</option>");
                    },
