            ...
            <table class="w-100">
                <tr>
                    <td class="text-center">
                        <img src="/custom/images/check-circle.svg" />
                        {{-- <img src="/custom/images/check-menu.svg" /> --}}
                    </td>
                </tr>
                <tr>
                    <td>
                        <h2 style="padding-top: 25px" class="text-center header-title mt-4">Thank you for choosing us!
                        </h2>
                    </td>
                </tr>
                {{-- <tr>
                    <td class="text-center">
                        <p style="max-width: 633px;display:inline-block">
                            Your order has been received. We'll process it shortly, and you'll receive an email
                            confirmation
                            with the details.
                        </p>
                    </td>
                                            ...
                                            <table class="w-100" style="border-collapse: separate;border-spacing: 0 30px;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img style="object-fit: cover;border-radius:12px"
                                                                 src="{{ getImage(imagePath()['product']['path'] . '/' . $sampleSet->image, imagePath()['product']['size'], false, 'sm') }}" width="178px"
                                                                 height="178px" />
                                                        </td>
                                                        <td class="w-100"
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left info-paragraph"
                                                                        style="font-weight: 600">{{ $sampleSet->event->name .' Sample Set' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-left info-paragraph"
                                                        ...
                                                        <td class="info-paragraph"
                                                            style="font-weight: 600;vertical-align:baseline">USD${{  number_format($sampleSet->price, 2) }}
                                                        </td>
                                                    </tr>
                                                ...
                                                @foreach($order->prices as $price)
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img style="object-fit: cover;border-radius:12px"
                                                                 src="{{ getImage(imagePath()['product']['path'] . '/' . $price->offer->photo, imagePath()['product']['size'], false, 'sm') }}" width="178px"
                                                                height="178px" />
                                                        </td>
                                                        <td class="w-100"
                                                            style="vertical-align: baseline;padding-left:20px">
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-left info-paragraph"
                                                                            style="font-weight: 600">{{$price->offer->name}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-left info-paragraph"
                                                        ...
                                                        <td class="info-paragraph"
                                                            style="font-weight: 600;vertical-align:baseline">USD${{ number_format($price->product_total_price, 2) }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                            ...
                            <table class="w-100" style="margin-top: 10px">
                                <tbody>
                                    ...
                                    <tr class="preferred-days-times">
                                        <td class="text-left info-paragraph">
                                            Preferred receiving day and time
                                        </td>
                                        <td class="text-right info-paragraph">
