...
@section('content')
        ...
        <div class="row justify-content-center g-4 mb-5">
            ...
            <div class="col-sm-6 col-xl-4 col-xxl-3"></div>
            <div class="col-sm-6 col-xl-4 col-xxl-3"></div>
            <div class="col-sm-6 col-xl-4 col-xxl-3"></div>
        </div>
                ...
                <tbody>
                    @foreach ($transactions as $transaction)
                        <tr>
                            ...
                            <td data-label="@lang('Amount')" class="{{ $transaction->trx_type == '+' ? 'text--success':'text--danger' }}">{{ $transaction->trx_type.showAmount($transaction->amount) }} {{ $general->cur_text }}</td>
                            <td data-label="@lang('Balance')" class="text--info">{{ showAmount($transaction->post_balance) }} {{ $general->cur_text }}</td>
