            ...
            <div class="col-md-8 col-xxl-6">
                <div class="card cmn--card">
                    ...
                    <div class="card-body p-4 text-center">
                        <h6 class="m-0">@lang('Please Pay') {{showAmount($deposit->final_amo)}} {{$deposit->method_currency}}</h6>
                        <h6 class="mt-3" class="my-3">@lang('To Get') {{showAmount($deposit->amount)}}  {{$general->cur_text}}</h6>
                    </div>
