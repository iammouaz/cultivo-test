...
<section class="latest-winner-section pt-120 pb-60">
    <div class="container">
        <div class="section__header text-center">
            <h3 class="section__title mt-0 text-center">{{ $winnerContent->data_values->heading }}</h3>
            <p class="section__txt">
                {{ $winnerContent->data_values->subheading }}
            </p>
                                ...
                                <td>
                                    <div class="latest__winner-item">
                                        ...
                                        <div class="latest__winner-content">
                                            <h6 class="title mb-2">{{ $winner->user->fullname }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <span class="product-name">{{ $winner->product->name }}</span>
                                </td>
                                <td>
