            ...
            <div class="col-lg-8">
                <div class="blog-details-wrapper">
                    <div class="blog-details-thumb">
                        <img class="w-100" src="{{ getImage('assets/images/frontend/blog/'.$blog->data_values->blog_image, '850x570') }}" alt="blog">
                    </div>
                    <div class="blog-details-content">
                        <div class="blog-details-header">
                            ...
                            <h3 class="title mb-4 mt-3">{{ $blog->data_values->title }}</h3>
                        </div>
							...
							@foreach ($recentBlogs as $blog)
								<div class="blog__item recent-blog">
									...
									<div class="blog__content">
										<h6 class="title"><a href="{{ route('blog.details', [$blog->id, slug($blog->data_values->title)]) }}">{{ $blog->data_values->title }}</a></h6>
