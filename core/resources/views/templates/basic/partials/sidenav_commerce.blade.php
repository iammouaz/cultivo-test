...
{{--                    <li>--}}
{{--                        <a href="{{route('user.invitations')}}" class="{{ menuActive('user.invitation') }}">--}}
{{--                            <i class="las la-users"></i>--}}
{{--                            <span class="cont">@lang('Invitations')</span>--}}
{{--                        </a>--}}
{{--                    </li>--}}
                    {{-- <li>
                    ...
                    <li>
                        <a href="{{ route('user.winning.history') }}" class="{{ menuActive('user.winning.history') }}">
                            ...
                            <span class="cont">@lang('Winning History')</span>
                        </a>
                    </li> --}}

{{--                    <li>--}}
{{--                        <a href="{{ route('user.checkout.index') }}" class="{{ menuActive('user.checkout.index') }}">--}}
{{--                            <i class="las la-trophy"></i>--}}
{{--                            <span class="cont">@lang('Checkout Page')</span>--}}
{{--                        </a>--}}
{{--                    </li>--}}
