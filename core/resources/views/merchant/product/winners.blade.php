                    ...
                    <table class="table table--light style--two">
                        ...
                        @forelse($winners as $winner)
                            <tr>
                                ...
                                <td data-label="@lang('User Name')">{{ $winner->user->fullname}}</td>
                                <td data-label="@lang('Product Name')"><a href="{{ route('product.details',[$winner->product->id, slug($winner->product->name)]) }}" target="_blank">{{ $winner->product->name}}</a></td>
