            ...
            @foreach($withdrawMethod as $data)
                ...
                <div class="col-xl-3 col-lg-5 col-md-5 mb-4">
                    <div class="card card-withdraw">
                        <h5 class="card-header bg--primary text-center">{{$data->name}}</h5>
                        <div class="card-body card-body-withdraw">
                            <img src="{{getImage(imagePath()['withdraw']['method']['path'].'/'. $data->image,imagePath()['withdraw']['method']['size'])}}" class="card-img-top" alt="{{$data->name}}" class="w-100">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text currency-addon">{{$general->cur_text}}</span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        (function ($) {
            ...
            $('.withdraw').on('click', function () {
                ...
                var withdrawLimit = `@lang('Withdraw Limit'): ${minAmount} - ${maxAmount}  {{$general->cur_text}}`;
                $('.withdrawLimit').text(withdrawLimit);
                var withdrawCharge = `@lang('Charge'): ${fixCharge} {{$general->cur_text}} ${(0 < percentCharge) ? ' + ' + percentCharge + ' %' : ''}`
